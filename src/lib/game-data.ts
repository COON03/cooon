...
export const allCustomers: Customer[] = [
    { 
        id: 'c1', name: '초보 모험가', sprite: 'Villager', requestText: "튼튼한 검 하나만 주세요!", wants: { type: 'Sword' }, patience: 30, personality: 'normal',
    ...
    { 
        id: 'c2', name: '성급한 산적', sprite: 'Rogue', requestText: "도끼! 아무 도끼나 빨리!", wants: { type: 'Axe' }, patience: 10, personality: 'impatient',
    ...
    { 
        id: 'c3', name: '엘프 정찰병', sprite: 'Villager', requestText: "혹시 활 가지고 계신가요?", wants: { type: 'Bow' }, patience: 35, personality: 'normal',
    ...
    { 
        id: 'c4', name: '왕실 기사', sprite: 'Knight', requestText: "날렵한 레이피어를 찾고 있네.", wants: { type: 'Rapier' }, patience: 40, personality: 'normal', minDay: 1,
    ...
    { 
        id: 'c5', name: '드워프 전사', sprite: 'Rogue', requestText: "혹시 체인으로 된 무기는 없나?", wants: { type: 'Chain' }, patience: 30, personality: 'normal', minDay: 2,
    ...
    { 
        id: 'c6', name: '느긋한 마법사', sprite: 'Mage', requestText: "마법 스태프가 필요합니다. 천천히 보여주세요.", wants: { type: 'Magic Staff' }, patience: 50, personality: 'normal', minDay: 3,
    ...
    { 
        id: 'c8', name: '고대 유적 탐험가', sprite: 'Villager', requestText: "이 채찍, 꽤 쓸만해 보이는데... 더 좋은 건 없나?", wants: { type: 'Whip' }, patience: 30, personality: 'normal', minDay: 3,
    ...
    { 
        id: 'c9', name: '사령술사', sprite: 'Mage', requestText: "영혼을 거두는 낫이 필요하다.", wants: { type: 'Scythe' }, patience: 45, personality: 'normal', minDay: 3,
    ...
    { 
        id: 'c10', name: '왕궁 근위대장', sprite: 'Knight', requestText: "던질 수 있는 무기... 부메랑 같은 건 없나?", wants: { type: 'Boomerang' }, patience: 30, personality: 'normal', minDay: 2,
    ...
    { 
        id: 'c12', name: '깐깐한 귀족', sprite: 'Knight', requestText: "내 품격에 맞는 무기는... 아주 찾기 어려울걸? 채찍이라도 보여주게.", wants: { type: 'Whip' }, patience: 25, personality: 'picky', minDay: 3,
    ...
    { 
        id: 'c_special1', name: '기사단장', sprite: 'Knight', requestText: "왕국 최고의 검을 가져오게.", wants: { type: 'Enhanced Sword' }, patience: 25, personality: 'special',
    ...
    {
        id: 'c_special2', name: '전설의 사냥꾼', sprite: 'Villager', requestText: "최고의 활이 필요하네. 마지막 사냥을 위해.", wants: { type: 'Enhanced Bow' }, patience: 20, personality: 'special',
    ...
    { 
        id: 'c_special3', name: '광전사 베르단', sprite: 'Rogue', requestText: "더 강한 도끼... 모든 걸 부술 도끼...!", wants: { type: 'Enhanced Axe' }, patience: 15, personality: 'special',
